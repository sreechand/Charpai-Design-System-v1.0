      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-charpai-cream/90 backdrop-blur-md border-b border-charpai-gold/30">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/charapai_logo.png" alt="Charpai" className="w-[90px] h-[90px] object-contain" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            <div className="max-w-sm">
              <div className="flex items-center gap-2 mb-3">
                <img src="/charapai_logo.png" alt="Charpai" className="w-[100px] h-[100px] object-contain" />
